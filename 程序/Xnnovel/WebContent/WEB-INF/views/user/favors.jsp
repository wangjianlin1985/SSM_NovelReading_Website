    ...
    <header>
        <div class="hidden-xs header"><!--超小屏幕不显示-->
            ...
            <ul class="nav hidden-xs-nav">
                ...
                <li class="active"><a href="/user/favors.html"><span class="glyphicon glyphicon-inbox"></span>我的收藏</a></li>
        ...
        <div class="content">
            <header class="news_header">
                <h2 class="title">
                    ...
                    <a href="/novel/info/${novel.id}.html"><small>我的收藏</small></a>
                </h2>
            </header>
            <div class="content-block new-content">
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                        <c:if test="${favorsList.size()>0}">
                            <c:forEach items="${favorsList}" var="favor" >
                                <tr>
                                    <td><a href="/novel/info/${favor.novel.id}.html">${favor.novel.title}</a></td>
                                    <td>${favor.createTime}</td>
                                    <td><button type="button" class="btn btn-danger btn-xs" id="remove"><i class="fa fa-remove" onclick="remove(${favor.id})">取消收藏</i></button></td>
                                </tr>
                            </c:forEach>
                        </c:if>
                        <c:if test="${favorsList.size()<=0}">
                            <tr>
                                <td colspan="3" style="text-align: center">暂无收藏书籍！</td>
                            </tr>
                        </c:if>
                        </tbody>
                    </table>
