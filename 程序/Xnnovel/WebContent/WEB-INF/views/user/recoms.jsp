    ...
    <header>
        <div class="hidden-xs header"><!--超小屏幕不显示-->
            ...
            <ul class="nav hidden-xs-nav">
                ...
                <li class="active"><a href="/user/recoms.html"><span class="glyphicon glyphicon-globe"></span>我的推荐</a></li>
        ...
        <div class="content">
            <header class="news_header">
                <h2 class="title">
                    ...
                    <a href="/novel/info/${novel.id}.html"><small>我的推荐</small></a>
                </h2>
            </header>
            <div class="content-block new-content">
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                        <c:if test="${recomsList.size()>0}">
                            <c:forEach items="${recomsList}" var="recoms" >
                                <tr>
                                    <td><a href="/novel/info/${recoms.novel.id}.html">${recoms.novel.title}</a></td>
                                    <td>${recoms.createTime}</td>
                                    <td><button type="button" class="btn btn-danger btn-xs" id="remove"><i class="fa fa-remove" onclick="remove(${recoms.id})">取消推荐</i></button></td>
                                </tr>
                            </c:forEach>
                        </c:if>
                        <c:if test="${recomsList.size()<=0}">
                            <tr>
                                <td colspan="3" style="text-align: center">暂无推荐书籍！</td>
                            </tr>
                        </c:if>
                        </tbody>
                    </table>
